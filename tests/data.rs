...
fn dce_xlsx() -> Result<()> {
    ...
    let mut writer = csv::WriterBuilder::new()
        ...
        .from_writer(Vec::with_capacity(size));
    let head = &table[..3];
    for record in head {
        writer.serialize(record)?;
    }
    writer.flush()?;
    shot!(std::str::from_utf8(writer.get_ref())?, @r###"
    v2201,2022-01-04,8292.0,8293.0,8578.0,8293.0,8550.0,8462.0,258.0,170.0,1914,80987940,26364
    v2201,2022-01-05,8462.0,8475.0,8483.0,8342.0,8353.0,8416.0,-109.0,-46.0,1762,74149720,25910
    v2201,2022-01-06,8416.0,8353.0,8382.0,8327.0,8382.0,8334.0,-34.0,-82.0,384,16001710,25826
    "###);
    shot!(Table::new(head), @r###"
    +-------+------------+------+------+------+------+-------+--------+------+-----+------+----------+----------+
    | code  | date       | prev | open | high | low  | close | settle | zd1  | zd2 | vol  | amount   | position |
    +-------+------------+------+------+------+------+-------+--------+------+-----+------+----------+----------+
    | v2201 | 2022-01-04 | 8292 | 8293 | 8578 | 8293 | 8550  | 8462   | 258  | 170 | 1914 | 80987940 | 26364    |
    +-------+------------+------+------+------+------+-------+--------+------+-----+------+----------+----------+
    | v2201 | 2022-01-05 | 8462 | 8475 | 8483 | 8342 | 8353  | 8416   | -109 | -46 | 1762 | 74149720 | 25910    |
    +-------+------------+------+------+------+------+-------+--------+------+-----+------+----------+----------+
    | v2201 | 2022-01-06 | 8416 | 8353 | 8382 | 8327 | 8382  | 8334   | -34  | -82 | 384  | 16001710 | 25826    |
    +-------+------------+------+------+------+------+-------+--------+------+-----+------+----------+----------+
    "###);
    Ok(())
}
